...
const manifest = [
  ...
  { key: 'piltorn',         src: '/assets/towers/piltorn_sprites.png',             cols: 4, rows: 4 },
  { key: 'hydda',           src: '/assets/towers/hydda_sprites.png',               cols: 4, rows: 4 },
  { key: 'isjatten',        src: '/assets/towers/isjatten_sprites.png',            cols: 4, rows: 4 },
  { key: 'drakship',        src: '/assets/towers/drakship_sprites.png',            cols: 4, rows: 4 },
  { key: 'raider',          src: '/assets/enemies/raider_sprites.png',             cols: 4, rows: 2 },
  { key: 'draugr',          src: '/assets/enemies/draugr_sprites.png',             cols: 4, rows: 2 },
  ...
  { key: 'warg',            src: '/assets/enemies/warg_sprites.png',               cols: 4, rows: 2 },
  { key: 'ashWarden',       src: '/assets/bosses/ash_warden_sprites.png',          cols: 4, rows: 2 },
