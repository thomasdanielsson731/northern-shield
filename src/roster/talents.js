...
export const TALENT_DEFS = {
  ...
  // ── Healer (hydda) ─────────────────────────────────────────────────────────
  hyd_natures_touch:    { name: "Nature's Touch",  class: 'hydda',    level: 3,  dm: 1.00, rm: 1.00, cm: 0.93, desc: '-7% heal cd' },
  hyd_mending_herbs:    { name: 'Mending Herbs',   class: 'hydda',    level: 5,  dm: 1.00, rm: 1.00, cm: 0.93, desc: '-7% heal cd' },
  hyd_runic_ward:       { name: 'Runic Ward',      class: 'hydda',    level: 8,  dm: 1.00, rm: 1.00, cm: 0.92, desc: '-8% heal cd' },
  hyd_living_fortress:  { name: 'Living Fortress', class: 'hydda',    level: 10, dm: 1.00, rm: 1.00, cm: 0.90, desc: '-10% heal cd' },
  // ── Ice Giant (isjatten) ───────────────────────────────────────────────────
